...
import org.usfirst.frc.team5546.robot.commands.DriveOverDefensesAfterDelay;
import org.usfirst.frc.team5546.robot.commands.DriveOverDefensesBackwards;
...
public class Robot extends IterativeRobot {
    ...
    public void robotInit() {
        ...
        chooser.addDefault("Delay then drive over defenses", new DriveOverDefensesAfterDelay());
        chooser.addDefault("Drive over backwards", new DriveOverDefensesBackwards());
        chooser.addObject("None", null);
        SmartDashboard.putData("Auto mode", chooser);
        
        modeChooser = new SendableChooser();
        modeChooser.addDefault("Normal", new Boolean(false));
        modeChooser.addObject("Slow", new Boolean(true));
